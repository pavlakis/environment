...
export ZSH=/Users/antonis/.oh-my-zsh
...
plugins=(
  git git-extras git-flow colored-man colorize github vagrant brew osx zsh-syntax-highlighting npm docker django bower celery node sublime sudo supervisor web-search
)
